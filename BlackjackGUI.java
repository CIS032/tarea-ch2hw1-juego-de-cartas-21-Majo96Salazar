  ...
  int dinero; // Cantidad de dinero que tiene el usuario.
        ...
        while (true) {
            ...
            do {
                ...
                String aux= "Tiene " + dinero + " dólares";
                apuesta = Integer.parseInt(JOptionPane.showInputDialog(null, auxp+ aux+"\n¿Cuántos dólares quieres apostar? (Ingresa 0 para finalizar)","Blackjack", JOptionPane.INFORMATION_MESSAGE));
                auxp="";
    ...
    static boolean jugarBlackjack() {
        ...
        String aux3= "";
            ...
            aux3+= "\n" + "El distribuidor muestra la " + manoDistribuidor.getCarta(0);
             ...
             String userAction="";
            do {
                userAction=JOptionPane.showInputDialog(null,"\"Seguir (S) o Quedarse (Q)?\"?");
                if (!userAction.equalsIgnoreCase("S") && !userAction.equalsIgnoreCase("Q")) {
                    userAction+= "Responda S o Q:";
                }
            ...
            } while (!userAction.equalsIgnoreCase("S") && !userAction.equalsIgnoreCase("Q"));
             ...
             */
            if (userAction.equalsIgnoreCase("Q")) {
