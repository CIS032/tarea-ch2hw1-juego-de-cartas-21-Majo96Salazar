...
public class Blackjack {
    ...
    static boolean jugarBlackjack() {
        ...
        while (true) {
            ...
            System.out.println();
            System.out.println("El concesionario muestra la" + manoDistribuidor.getCarta(0));
            System.out.println();
            ...
            do {
                ...
                if (userAction != 'S' && userAction != 'Q') 
                    System.out.print("Responda S o Q:");
                
                
            } while (userAction != 'S' && userAction != 'Q'); 
        ...
        if (manoDistribuidor.getBlackjackValor()== usuarioMano.getBlackjackValor()) {
            ...
            System.out.println("El distribuidor gana," + manoDistribuidor.getBlackjackValor()
                    + "apunta a" + usuarioMano.getBlackjackValor()+ ".");
            return false;
        } else {
            System.out.println("Usted gana, " + usuarioMano.getBlackjackValor()
                    + "apunta a" + manoDistribuidor.getBlackjackValor()+ ".");
            return true;
        }
